...
import com.kylin.electricassistsys.dao.ghdg.TGhdgDwyxzbDao;
...
@Service
@Transactional
public class TGhdgDwyxzbServiceImap extends ServiceImpl<TGhdgDwyxzbDao, TGhdgDwyxzb> implements TGhdgDwyxzbService {
