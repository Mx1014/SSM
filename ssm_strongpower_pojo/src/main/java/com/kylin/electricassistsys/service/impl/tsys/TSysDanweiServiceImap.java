...
import com.kylin.electricassistsys.dao.tsys.TSysDanweiDao;
...
@Service
@Transactional
public class TSysDanweiServiceImap extends ServiceImpl<TSysDanweiDao, TSysDanwei> implements TSysDanweiService {
