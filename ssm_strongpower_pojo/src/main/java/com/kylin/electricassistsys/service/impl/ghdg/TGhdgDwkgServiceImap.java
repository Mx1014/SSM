...
import com.kylin.electricassistsys.dao.ghdg.TGhdgDwkgDao;
...
@Service
@Transactional
public class TGhdgDwkgServiceImap extends ServiceImpl<TGhdgDwkgDao, TGhdgDwkg> implements TGhdgDwkgService {
