...
import com.kylin.electricassistsys.dao.jcsj.TJcsjCtbbDao;
...
@Service
@Transactional
public class TJcsjCtbbServiceImap extends ServiceImpl<TJcsjCtbbDao, TJcsjCtbb> implements TJcsjCtbbService {
