...
public class RSATools {
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = EncodeUtils.decode(privateKey);
        ...
        return EncodeUtils.encode(signature.sign());
    }
    ...
    public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
        byte[] keyBytes = EncodeUtils.decode(publicKey);
        ...
        signature.update(data);
        return signature.verify(EncodeUtils.decode(sign));
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap) throws Exception {
        ...
        return EncodeUtils.encode(key.getEncoded());
    }
    ...
    public static String encryptedDataOnJava(String data) {
        try {
            data = EncodeUtils.encode(encryptByPublicKey(data.getBytes(), PUBLICKEY));
        } catch (Exception e) {
    ...
    public static String decryptDataOnJava(String data) {
        String temp = "";
        try {
            byte[] rs = EncodeUtils.decode(data);
