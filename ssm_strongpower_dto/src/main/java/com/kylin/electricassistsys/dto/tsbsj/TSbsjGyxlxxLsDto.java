 ...
 * @since 2018-04-24
 */
public class TSbsjGyxlxxLsDto extends BaseDto {


    private String tGyxlxxLsid;
    ...
    private String tGyxlxxXgr;
    private String tGyxlxxXgsj;
    /**
     * 电缆型号
     */
    ...
    public String gettGyxlxxLsid() {
        return tGyxlxxLsid;
    }

    public void settGyxlxxLsid(String tGyxlxxLsid) {
        this.tGyxlxxLsid = tGyxlxxLsid;
    }
    ...
    public String gettGyxlxxXgr() {
        return tGyxlxxXgr;
    }

    public void settGyxlxxXgr(String tGyxlxxXgr) {
        this.tGyxlxxXgr = tGyxlxxXgr;
    }

    public String gettGyxlxxXgsj() {
        return tGyxlxxXgsj;
    }

    public void settGyxlxxXgsj(String tGyxlxxXgsj) {
        this.tGyxlxxXgsj = tGyxlxxXgsj;
    }
    ...
    public String toString() {
        return "TSbsjGyxlxxLs{" +
                "tGyxlxxLsid=" + tGyxlxxLsid +
                ", tGyxlxxId=" + tGyxlxxId +
                ...
                ", tGyxlxxXgr=" + tGyxlxxXgr +
                ", tGyxlxxXgsj=" + tGyxlxxXgsj +
