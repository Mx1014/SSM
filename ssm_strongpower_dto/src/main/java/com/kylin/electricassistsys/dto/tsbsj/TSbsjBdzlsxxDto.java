 ...
 * @since 2018-04-24
 */
public class TSbsjBdzlsxxDto extends BaseDto {

    private static final long serialVersionUID = 1L;

    private String tBdzlsxxId;
    ...
    private String tBdzxxXgr;
    private String tBdzxxXgsj;
    ...
    public String gettBdzlsxxId() {
        return tBdzlsxxId;
    }

    public void settBdzlsxxId(String tBdzlsxxId) {
        this.tBdzlsxxId = tBdzlsxxId;
    }
    ...
    public String gettBdzxxXgr() {
        return tBdzxxXgr;
    }

    public void settBdzxxXgr(String tBdzxxXgr) {
        this.tBdzxxXgr = tBdzxxXgr;
    }

    public String gettBdzxxXgsj() {
        return tBdzxxXgsj;
    }

    public void settBdzxxXgsj(String tBdzxxXgsj) {
        this.tBdzxxXgsj = tBdzxxXgsj;
    }
