--------------------------------------------------------
--  文件已创建 - 星期一-七月-16-2018   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Function FUN_BDZDQDLYXBYID
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "FUN_BDZDQDLYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站地区电流
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZDQWGYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站地区无功
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZDQZDFHYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站地区最大负荷
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZJFDLCOUNT" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站年积分电量
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZZDFHFSSKYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站地区最大负荷发生时刻
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZZSZDFHFSSKYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站自身最大负荷发生时刻
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BDZZSZDFHYXBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站自身最大负荷
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_BYQXGCISHUBYBYQID" (byqid varchar2) return varchar2 is
xgcs number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZDQYXBYID_FZL" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站地区运行负载率
rl number;
szgl number;
fzl varchar2(50);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZDQYXBYID_GLYS" (bdzid in varchar2,nf in varchar2) return varchar2 is
--变电站地区功率因数
yg number;
szgl number;
glys varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZDQYXBYID_SZGL" (bdzid in varchar2,nf in varchar2) return varchar2 is
--变电站地区视在功率
yg number;
wg number;
szgl varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZSFHBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
--变电站省/年负荷
str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZSFHZDFSSKBYID" (bdzid in varchar2,nf in varchar2) return varchar2 is
--变电站省/年最大负荷发生时刻
str varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZYXBYID_FZL" (bdzid in varchar2,nf in varchar2,tq in varchar2) return varchar2 is
 --变电站自身运行负载率
 jgids varchar2(36);
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BDZZSYXBYID_FZL" (bdzid in varchar2,nf in varchar2) return varchar2 is
 --变电站自身运行负载率
 jgids varchar2(36);
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_BYQYXBYID_FZL" (byq in varchar2,nf in varchar2,tq in varchar2) return varchar2 is
 --变压器运行负载率
 jgids varchar2(36);
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_FZL_BYBDZID" (Id in varchar2) return varchar2 is
----变电站负载率
bdzid varchar2(36);
rl number;
szgl number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_FZL_BYBYQID" (Id in varchar2) return varchar2 is
----变压器负载率
byqid varchar2(36);
rl number;
szgl number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_FZL_BYGYXLID" (Id in varchar2) return varchar2 is
----高压负载率
gyxlId varchar2(50);
dl number;
aqdl number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_FZL_BYZYXLID" (Id in varchar2) return varchar2 is
----中压负载率
zyxlId varchar2(50);
dl number;
aqdl number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GLYS_BYBDZID" (Id in varchar) return varchar2 is
--变电站功率因数
yg number;
szgl number;
glys varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GLYS_BYBYQID" (Id in varchar) return varchar2 is
--变压器功率因数
yg number;
szgl number;
glys varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GLYS_BYGYXLID" (Id in varchar) return varchar2 is
--高压功率因数
yg number;
szgl number;
glys varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GLYS_BYZYXLID" (Id in varchar) return varchar2 is
--中压功率因数
yg number;
szgl number;
glys varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GYDQANDSZDFH" (gyxlId in varchar2,selYear in varchar2,lx in varchar2) return varchar2 is
  --高压线路地区/省最大负荷
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_GYDQANDSZDFHFSSK" (gyxlId in varchar2,selYear in varchar2,lx in varchar2) return varchar2 is
  --高压线路地区/省最大负荷发生时刻
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_SZGL_BYBDZID" (Id in varchar2) return varchar2 is
--变电站视在功率
yg number;
wg number;
szgl varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_SZGL_BYBYQID" (Id in varchar2) return varchar2 is
--变压器视在功率
yg number;
wg number;
szgl varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_SZGL_BYGYXLID" (Id in varchar2) return varchar2 is
--高压视在功率
yg number;
wg number;
szgl varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_SZGL_BYZYXLID" (Id in varchar2) return varchar2 is
--中压线路视在功率
yg number;
wg number;
szgl varchar2(10);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_CTPX" (xlid in varchar2) return varchar2 is
--判断CT变比偏小问题
  ct number;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_CWFJY" (xlid in varchar2) return varchar2 is
--判断城网非绝缘线问题
  cw varchar2(100);
  dxxh varchar2(100);
  typed varchar2(100);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_JXMS" (xlid in varchar2) return varchar2 is
--判断接线模式问题
  llx varchar2(100);
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_PBRL" (xlid in varchar2) return varchar2 is
--判断CT变比偏小问题
  zrl number;
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_ZGXCD" (xlid in varchar2) return varchar2 is
--判断主干线长度问题
  zgxcd number;
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WT_ZXJM" (xlid in varchar2) return varchar2 is
--判断最小截面问题
  dxmc varchar2(100);
  zxjm number;
  ret_result varchar2(36);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_CTPX" (xlid in varchar2) return varchar2 is
--判断CT变比偏小问题级别
  ct number;
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_CWFJY" (xlid in varchar2) return varchar2 is
--判断城网非绝缘线问题
  cw varchar2(100);
  dxxh varchar2(100);
  typed varchar2(100);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_JXMS" (xlid in varchar2) return varchar2 is
--判断接线模式问题级别
  llx varchar2(100);
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_PBRL" (xlid in varchar2) return varchar2 is
--判断配变容量问题级别
  zrl number;
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_ZGXCD" (xlid in varchar2) return varchar2 is
--判断主干线长度问题级别
  zgxcd number;
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET_WTJB_ZXJM" (xlid in varchar2) return varchar2 is
--判断最小截面问题级别
  dxmc varchar2(100);
  zxjm number;
  ret_result varchar2(36);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET10KVCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET10KVYYCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET110KVCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET110KVYYCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET220KVCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET220KVYYCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET35KVCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GET35KVYYCXJGZSBYID" (bdzId in varchar2) return varchar2 is
zs varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETAZXSNAMEBYID" (ids in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZ_BYZYXLID" (xlId in varchar2) return varchar2 is
bdz varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZ_ZDFHFSSK" (bdzId in varchar2,selYear in varchar2) return varchar2 is
  --变电站最大负荷发生时刻
  ret_result varchar2(100);
begin
   if(selYear='')
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZBYBYQID" (byqId in varchar2) return varchar2 is
bdz varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZBYID" (bdzId in varchar2) return varchar2 is
bdz varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZBYQTSBYBDZID" (bdzId in varchar2) return number is
byqts number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZCOUNT" (dydj in varchar2,nf in varchar2) return varchar2 is
--电压等级对应变电站个数
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZRL" (dydj in varchar2,nf in varchar2) return varchar2 is
--电压等级对应变电站容量
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZRLBYBDZID" (bdzId in varchar2) return number is
byqrl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZRLBYBDZIDANDSJ" (bdzId in varchar2,sj in varchar2) return number is
byqrl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZRLGOUCHENGBYBDZID" (bdzId in varchar2) return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZTYPE" (Ids in varchar2) return varchar2 is
--变电站类型
xlmc varchar2(50);
cishu number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZWGBCGOUCHENGBYBDZID" (bdzId in varchar2) return varchar2 is
--无功补偿构成
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZWGBCRLBYBDZID" (bdzId in varchar2) return number is
--无功补偿容量
byqrl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZXGCISHUBYBDZID" (bdzId in varchar2) return number is
xgcs number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZZRL" (nf in varchar2) return varchar2 is
--变电站容量
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBDZZS" (nf in varchar2) return varchar2 is
--变电站个数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBYQ_ZDFHFSSK" (bdzId in varchar2,selYear in varchar2) return varchar2 is
  --变压器最大负荷发生时刻
  ret_result varchar2(100);
begin
   if(selYear='')
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBYQTAISHURLBYBDZID" (bdzId in varchar2) return number is
byqts number;
begin
  select count(T_BYQXX_ID) into byqts from T_sbsj_byqxx where T_BYQXX_BDZID = bdzId;
  return(byqts);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBYQTAISHURLBYBDZIDANDSJ" (bdzId in varchar2,sj in varchar2) return number is
byqts number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBYQYX_ZDFH" (byq in varchar2,nf in varchar2,tq in varchar2) return varchar2 is
 --变压器运行最大负荷
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETBYQYX_ZDFHFSSK" (byq in varchar2,nf in varchar2,tq in varchar2) return varchar2 is
 --变压器运行最大负荷发生时刻
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETCNWNAMEBYID" (Id in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETCTBBNAMEBYID" (Ids in varchar2) return varchar2 is
--CT变比
names varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDIANLIUBYXLIDANDSJ" (c_xlId in varchar2, shijian in varchar2) return number is
--获取电流
  qitaFuHe number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDXXHBYDXID" (dxid in varchar2) return varchar2 is
dxxh varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDYDJ_BYBYQID" (byqId in varchar2) return varchar2 is
dydj varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDYDJ_BYGYXLID" (xlId in varchar2) return varchar2 is
dydj varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDYDJBYBDZID" (bdzId in varchar2) return varchar2 is
dydj number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDYDJBYID" (dydjid in varchar2) return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETDYNAMEBYID" (dy_Id in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDFQBYID" (city_id in varchar2) return varchar2 is
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDKKL" (cnw in varchar2 ,nf in varchar2) return varchar2 is
--供电可靠率(RS-3)城农网
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDQSXBYBDZID" (bdzId in varchar2) return varchar2 is
Gdqsx varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDQYNAMEBYID" (qy_Id in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDXZBYBDZID" (bdzId in varchar2) return varchar2 is
gdxz varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGDXZBYDWID" (ywdwId in varchar2) return varchar2 is
YWDW varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGHKXXZTZ" (ids in varchar2) return varchar2 is
--规划库每一个节点总投资信息
ztz varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQLX_BYBYQID" (byqId in varchar2) return varchar2 is
GQLX varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQLX_BYGYXLID" (xlId in varchar2) return varchar2 is
GQLX varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQLX_BYZYXLID" (xlId in varchar2) return varchar2 is
GQLX varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQLXBYBDZID" (bdzId in varchar2) return varchar2 is
gqlx varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQLXNAMEBYID" (gqlx_Id in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGQMJ" (nf in varchar2) return varchar2 is
--供区面积
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHBDZRLBYID" (gyghId in varchar2) return number is
bdrl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHBDZTZBYID" (gyghId in varchar2) return number is
bdztz number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHDLCDBYID" (gyghId in varchar2) return number is
dlcd number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHJKCDBYID" (gyghId in varchar2) return number is
jkcd number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHXLCDBYID" (gyghId in varchar2) return number is
xlcd number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHXLTSBYID" (gyghId in varchar2) return number is
xlts number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYGHXLTZBYID" (gyghId in varchar2) return number is
xltz number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYXL_ZDFHFSSK" (gyxlId in varchar2,selYear in varchar2) return varchar2 is
  --高压线路最大负荷发生时刻
  ret_result varchar2(100);
begin
   if(selYear='')
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYXLDLCDBYSJ" (xlId in varchar2,shijian in varchar2) return varchar2 is
jkxlcd number;
tiaoCount number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYXLJKCDBYSJ" (xlId in varchar2,shijian in varchar2) return varchar2 is
jkxlcd number;
tiaoCount number;
begin
  select count(*) into tiaoCount from t_sbsj_gyxlxx_ls where T_Gyxlxx_Id = xlId  and
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETGYXLXGCISHUBYID" (gyxlid in varchar2) return number is
 xgcs number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETISNUMBER" (str in varchar2) return varchar2 is
--判断是否是数字
strs varchar2(10);
reges varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETJCMBNAMEBYID" (JcMb_Id in varchar2) return varchar2 is
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETJGSYZT" (openJgName varchar2) return varchar2 is
--判断使用状态
syzt varchar2(200);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETJSBYQNBYBDZID" (bdzId in varchar2, shijian in varchar2) return varchar2 is
--根据变电站和时间判断是否通过N-1校验
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETJXSSGL_BYDXXHID" (dxid in varchar2,dydjname in varchar2) return varchar2 is
--极限输送功率
req_requper number;
aqdl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLIANLUOFANGSHIBYXLID" (xlId in varchar2) return varchar2 is
llfs varchar2(100);
lxCount int;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLIANLUOFANGSHILSBYXLID" (xlId in varchar2,UpdataTime in varchar2) return varchar2 is
llfs varchar2(100);
lxCount int;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLIANLUOLSXIANNAME" (xlId in varchar2,xlIndex number,leixing varchar2,cishu number) return varchar2 is
lxName varchar2(100);
begin
  if(leixing ='zj')
  then
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLIANLUOXIANJXSL" (zyxlId in Varchar2) return number is
  xg_count number ;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLIANLUOXIANNAME" (xlId in varchar2,xlIndex number,leixing varchar2) return varchar2 is
lxName varchar2(100);
begin
  if(leixing = 1)
  then
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETLLXNAME" (xlId in varchar2) return varchar2 is
lxName varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETMPBBNAMEBYID" (Ids in varchar2) return varchar2 is
--铭牌变比
names varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETMYXLIDBYOPENXLIDANDDYDJ" (openXlId varchar2,xlDydjId varchar2) return varchar2 is
myXlId varchar2(200);
dyName varchar2(200);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETPDZZLXNAMEBYID" (ids in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQITAFHBYBYQIDANDSHIJIAN" (c_byqId in varchar2, shijian in varchar2) return number is
  qitaFuHe number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQITARONGLIANGBYBYQID" (c_byqId in varchar2) return number is
qitaRl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQSHYDL" (nf in varchar2) return varchar2 is
--全社会用电量
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQY_BYBYQID" (byqId in varchar2) return varchar2 is
qy varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQY_BYGYXLID" (xlId in varchar2) return varchar2 is
qy varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQY_BYZYXLID" (xlId in varchar2) return varchar2 is
qy varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETQYNAMEBYBDZID" (bdzId in varchar2) return varchar2 is
qy varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETSYFS_BYBDZID" (bdzId in varchar2) return varchar2 is
syfs varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETSYFS_BYBYQID" (byqId in varchar2) return varchar2 is
syfs varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETSYFS_BYZYXLID" (xlId in varchar2) return varchar2 is
syfs varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETSYFSNAMEBYID" (Ids in varchar2) return varchar2 is
--使用方式
names varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETTYFSNAMEBYID" (Ids in varchar2) return varchar2 is
--调压方式
names varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETUSERNAMEBYID" (Us_Id in varchar2) return varchar2 is
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETXLIDBYJGIDANDDYDJ" (openJgId varchar2,dydjName varchar2) return varchar2 is
myXlId varchar2(200);
countIndex number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETXLIDBYJGIDANDLX" (openJgId varchar2,dydjName varchar2) return varchar2 is
myXlId varchar2(200);
countIndex number;
begin
    select count(*) into countIndex from ems.bay_device_info@jkdata  where  bay_id= openJgId ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETXZGYBDZTSBYID" (gyghId in varchar2) return number is
bdzts number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETYWDW_BYZYXLID" (xlId in varchar2) return varchar2 is
ywdw varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETYWDWBYBDZID" (bdzId in varchar2) return varchar2 is
ywdw varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETYWDWNAMEBYID" (ywdwId in varchar2) return varchar2 is
YWDW varchar2(36);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZDFSSK_BYXLID" (xlids in varchar2,nf in varchar2) return varchar2 is
--AB侧最大时刻
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZDYG_BYXLID" (xlids in varchar2,nf in varchar2) return varchar2 is
--AB侧最大有功
req_requper number;
aqdl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZDYGID_BYXLID" (xlids in varchar2,nf in varchar2) return varchar2 is
--AB侧最大时刻
req_requper varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZHDYHGL" (cnw in varchar2 ,nf in varchar2) return varchar2 is
--综合电压合格率城农网
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZHXSL10" (nf in varchar2) return varchar2 is
--10千伏及以下综合线损率(%)
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZHXSL110" (nf in varchar2) return varchar2 is
--110千伏及以下综合线损率(%)
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZRK" (nf in varchar2) return varchar2 is
--总人口
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYGHGZQRLBYID" (zyghId in varchar2) return number is
pbrl number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYGHZTSBYID" (zyghId in varchar2) return number is
bdztz number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXL_CNWANDSYFSCOUNT" (cnw in varchar2,syfs in varchar2,nf in varchar2) return varchar2 is
--10kV城、农网对应公用线路条数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXL_CNWCOUNT" (cnw in varchar2,nf in varchar2) return varchar2 is
--10kV城、农网对应线路条数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXL_ZDFHFSSK" (zyxlId in varchar2,selYear in varchar2) return varchar2 is
  --中压线路最大负荷发生时刻
  ret_result varchar2(100);
begin
   if(selYear='')
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLCOUNT" (nf in varchar2) return varchar2 is
--10kV线路条数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLHWG" (nf in varchar2) return varchar2 is
--10kV环网柜数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLTYPE" (Ids in varchar2) return varchar2 is
--中压线路类型
xlmc varchar2(50);
cishu number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLXGCOUNTBYID" (zyxlId in Varchar2) return number is
  xg_count number ;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLZGXPJCD" (nf in varchar2) return varchar2 is
--10kV柱上开关数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYXLZSKG" (nf in varchar2) return varchar2 is
--10kV柱上开关数
re_region varchar2(50);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GETZYZNZJLLXBYXLID" (Ids in varchar2) return varchar2 is
--站内、站间联络线
xlmc varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "FUN_GYXLJFDLCOUNT" (xlid in varchar2,nf in varchar2) return varchar2 is
 --高压线路积分电量
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_BDZ_ZDFH" (bdzId in varchar2,selYear in varchar2) return varchar2 is
  --变电站最大负荷
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_BDZ_ZDFZL" (bdzId in varchar2,selYear in varchar2) return varchar2 is
  --变电站最大负载率
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_BYQ_ZDFH" (byqIds in varchar2,selYear in varchar2) return varchar2 is
  --变压器最大负荷
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_BYQ_ZDFZL" (bdzId in varchar2,selYear in varchar2) return varchar2 is
  --变压器最大负载率
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_GYXL_ZDFH" (gyxlId in varchar2,selYear in varchar2) return varchar2 is
  --高压线路最大负荷
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_GYXL_ZDFZL" (gyxlId in varchar2,selYear in varchar2) return varchar2 is
  --高压线路最大负载率
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_NEWYEAR" (yaer in varchar2) return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_ZYXL_ZDFH" (zyxlId in varchar2,selYear in varchar2) return varchar2 is
  --中压线路最大负荷
  ret_result varchar2(100);
  str varchar2(10);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GET_ZYXL_ZDFZL" (zyxlId in varchar2,selYear in varchar2) return varchar2 is
  --中压线路最大负载率
  ret_result varchar2(100);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETBDZID" (openBdzName in varchar2)
 return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETBDZMAXFUHE" (f_acId in char,shiJian in char)
 return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETBDZMAXFUHEBYCM" (f_acId in char,shiJian in char,cmLeiXing in varchar2)
 return varchar2 is
 ret_result varchar(100);
 strsql varchar(4000);
 tableName varchar(100);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETBYQID" (openByqName in varchar2,bdzid in varchar2)
 return varchar2 is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETFZLQJ" (qjlx char,fhz number) return varchar2 is
  ret_result varchar(200) ;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETGYXLID" (openGyxlName in varchar2)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETGYXLIDBYLD" (openZyxlName in varchar2)
 --根据op3000线路名称获取对应我们系统的线路Id
 return varchar2 is
 ret_result varchar(200);
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETMAXFUHE" (tableName in char,ziDuan in char,shiJian in char,flagType in char)
 return varchar2 is
 ret_result varchar(200);
 strsql varchar(5000);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETMAXFUHENOSHOWTIME" (tableName in char,ziDuan in char,shiJian in char)
 return varchar2 is
 ret_result varchar(200);
 strsql varchar(5000);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETYAOGANZHIBYYOUGONGTIME" (tableName in char,ziDuan in char,shiJian in char)
 return varchar2 is
 ret_result varchar(100);
 strsql varchar(500);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "GETZYXLID" (openZyxlName in varchar2)
 return varchar2 is
 ret_result varchar(200);
 countIndex number;
begin
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "JCMBGETIDBYNAME" (JcMb_Id in varchar2) return varchar2 is
  ret_result varchar2(36);
begin
  select T_JcMb_Name into ret_result from t_Jcsj_Jcmb where T_Jcmb_Id = JcMb_Id;
  return(ret_result);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "STRSPLIT" (p_value varchar2, p_split varchar2 := '_')
